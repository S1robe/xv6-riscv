...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	de2b8b93          	addi	s7,s7,-542 # 1398 <malloc+0x15a>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	db050513          	addi	a0,a0,-592 # 1378 <malloc+0x13a>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cf060613          	addi	a2,a2,-784 # 13a0 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	ce0b0b13          	addi	s6,s6,-800 # 13c0 <malloc+0x182>
  ...
  return ret;
     ...
     71e:	c8e50513          	addi	a0,a0,-882 # 13a8 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c3450513          	addi	a0,a0,-972 # 13b0 <malloc+0x172>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	c1260613          	addi	a2,a2,-1006 # 13c8 <malloc+0x18a>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	baaa0a13          	addi	s4,s4,-1110 # 13d0 <malloc+0x192>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b7c60613          	addi	a2,a2,-1156 # 13d8 <malloc+0x19a>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ade60613          	addi	a2,a2,-1314 # 13a0 <malloc+0x162>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	afe60613          	addi	a2,a2,-1282 # 13f0 <malloc+0x1b2>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     938:	aac50513          	addi	a0,a0,-1364 # 13e0 <malloc+0x1a2>
     93c:	fffff097          	auipc	ra,0xfffff
     940:	71a080e7          	jalr	1818(ra) # 56 <panic>
    panic("syntax - missing )");
     944:	00001517          	auipc	a0,0x1
     948:	ab450513          	addi	a0,a0,-1356 # 13f8 <malloc+0x1ba>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ae870713          	addi	a4,a4,-1304 # 1458 <malloc+0x21a>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9f460613          	addi	a2,a2,-1548 # 1410 <malloc+0x1d2>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	9c658593          	addi	a1,a1,-1594 # 1418 <malloc+0x1da>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6fc080e7          	jalr	1788(ra) # 1158 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	94450513          	addi	a0,a0,-1724 # 13a8 <malloc+0x16a>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	9a448493          	addi	s1,s1,-1628 # 1428 <malloc+0x1ea>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b3e:	8f658593          	addi	a1,a1,-1802 # 1430 <malloc+0x1f2>
     b42:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f06:	5ce50513          	addi	a0,a0,1486 # 14d0 <digits>
     f0a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    100a:	47270713          	addi	a4,a4,1138 # 1478 <malloc+0x23a>
  ...
  putc(fd, 'x');
    ...
    1094:	440b8b93          	addi	s7,s7,1088 # 14d0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10e8:	38c90913          	addi	s2,s2,908 # 1470 <malloc+0x232>
        while(*s != 0){
